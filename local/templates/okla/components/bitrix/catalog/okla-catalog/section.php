...
<div class="st-block fright">
    ...
    $pageCount = $_REQUEST['pageCount'] ? $_REQUEST['pageCount'] : 24;

    $sortField = $_REQUEST['sort'] ? $_REQUEST['sort'] : 'property_MINIMUM_PRICE';
    $sortOrder = $_REQUEST['order'] ? $_REQUEST['order'] : 'asc';
    ?>
    <div class="catalog-ajax-container">
        <?
            if($_REQUEST['set_filter'] == 'Y' && MainHelper::isAjaxRequest()){
